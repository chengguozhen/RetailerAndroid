 ...
 * 商品列表适配器
 */
public class MerchandiseCountAdapter extends ParentBaseAdapter implements View.OnClickListener{
    ...
    public MerchandiseCountAdapter(Context context, List<MerchandiseItemBean> list)
    {
