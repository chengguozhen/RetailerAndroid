...
public abstract class KindSectionedBaseAdapter extends BaseAdapter implements KindPinnedHeaderListView.PinnedSectionedHeaderAdapter {
    ...
    public KindSectionedBaseAdapter() {
        super();
